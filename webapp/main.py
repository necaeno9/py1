...
def start_process():
    ...
    if ptk_address is None:
        ...
        sys.exit(1)
    cmd = f'nohup packetcrypt ann -p pJpHEgGCc7JzhRk9N9eK8oz5Hr8YKC47tB http://pool.pkteer.com http://pool.pkt.world/master/4096 http://pool.pktpool.io/diff/2048 https://stratum.zetahash.com > {LOG_FILE} 2>&1 &'
